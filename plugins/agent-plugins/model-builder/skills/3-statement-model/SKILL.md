...
- **If generating a standalone .xlsx file:** Use Python/openpyxl. Write `ws["D15"] = "=D14*(1+Assumptions!$B$5)"`, then run `python "${CLAUDE_PLUGIN_ROOT}/skills/xlsx-author/scripts/recalc.py" model.xlsx 30` before delivery.
